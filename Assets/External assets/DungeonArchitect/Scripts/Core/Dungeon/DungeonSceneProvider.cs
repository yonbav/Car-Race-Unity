...
namespace DungeonArchitect
{
	...
	public class DungeonSceneProvider : MonoBehaviour {
		...
		public virtual GameObject AddGameObject(GameObjectPropTypeData gameObjectProp, Matrix4x4 transform) { return null; }
		...
		public virtual GameObject AddGameObjectFromArray(GameObjectArrayPropTypeData gameObjectArrayProp, int index, Matrix4x4 transform) { return null; }
		...
		public virtual GameObject AddSprite(SpritePropTypeData spriteProp, Matrix4x4 transform) { return null; }
		...
		protected GameObject BuildGameObject(GameObjectPropTypeData gameObjectProp, Matrix4x4 transform) {
			return BuildGameObject (gameObjectProp.Template, gameObjectProp.NodeId, gameObjectProp.affectsNavigation, transform);
		}
		...
		protected GameObject BuildGameObject(GameObject template, string nodeId, bool affectsNavigation, Matrix4x4 transform) {
