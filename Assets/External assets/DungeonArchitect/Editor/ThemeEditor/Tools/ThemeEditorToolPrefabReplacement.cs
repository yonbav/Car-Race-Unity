...
namespace DungeonArchitect.Editors.ThemeEditorTools
{
    ...
    public class ThemeEditorToolPrefabReplacement
    {
        ...
        public static void BuildReplacePrefab(DungeonArchitectGraphEditor editor)
        {
    ...
    {
        void DrawGUI();
        BulkReplacementEntry[] Process(DungeonArchitectGraphEditor editor);
    }
    ...
    class DirectoryBulkPrefabReplaceRuleProcessor : IBulkPrefabReplaceRuleProcessor
    {
        ...
        public BulkReplacementEntry[] Process(DungeonArchitectGraphEditor editor)
        {
    ...
    class BulkPrefabReplacementWindow : EditorWindow
    {
        ...
        DungeonArchitectGraphEditor graphEditor = null;
        public DungeonArchitect.Editors.DungeonArchitectGraphEditor GraphEditor
        {
